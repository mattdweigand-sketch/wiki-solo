...
This command is just a Claude Code shortcut. The workflow file is canonical and model-agnostic. Return an audit unless durable-write intent is already clear. After an approved capture-gate rerun, run `python3 scripts/validate_capture_runs.py`.
