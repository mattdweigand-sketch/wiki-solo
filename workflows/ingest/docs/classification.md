...
The full template for what each source type is *trustworthy for* and *should emphasize* is in [`../../../wiki/SCHEMA.md`](../../../wiki/SCHEMA.md) under "Source-Type Summary Templates."
