...
| Promote a useful artifact into durable wiki memory | [`workflows/maintenance/CONTEXT.md`](workflows/maintenance/CONTEXT.md) to [`artifact-promotion.md`](workflows/maintenance/artifact-promotion.md) | `wiki/SCHEMA.md`, `wiki/index.md`, `scripts/wiki_promote.py`, `scripts/capture_gate.py` |
