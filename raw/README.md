...
Drop source documents here, organized into the subfolders defined in [`wiki/domain.md`](../wiki/domain.md) under `raw_taxonomy`. Then run `/ingest` to triage, extract, and link them into wiki pages.
