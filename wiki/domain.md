...
| `entity_types_active` | Subset of the 13 entity types from [`schema.md`](../.agents/workspaces/ingest/docs/schema.md) that this wiki uses. Drop any that don't fit your domain. |
